...
if (count($_GET))
{
	$calc2013 = Tax::factory(2013);
        ...
        {
        	$errors = $calc2013->getErrors();
        }

	$calc2014 = Tax::factory(2014);

        if ($calc2014->setDetails($_GET))
        {
		if ($_GET['tax_benefit']) $calc2014->taxBenefit();
		//$calc2014->setPrsi($_GET['prsi']/ 100);
        //        $calc2014->setTopUsc($_GET['usc'] / 100);
		$calc2014->calculate();
                $breakdown2014 = $calc2014->getBreakdown();
//              echo '<pre>' . print_r($breakdown2014, 1) . '</pre>';
        }
					...
					<div class="entry-content">
						...
						<table id="taxtable">
							...
							<tr>
								...
								<td><?php echo number_format(($breakdown2014['gross'] + $breakdown2014['spouseGross']), 2); ?></td>
								<td>&nbsp;</td>
							</tr>
							<tr class="gross-row hidden">
								<td class="sub-item">Salary</td>
								<td><?php echo number_format($breakdown2013['salary'], 2); ?></td>
								<td><?php echo number_format($breakdown2014['salary'], 2); ?></td>
								<td>&nbsp;</td>	
							</tr>
							<?php if ($breakdown2013['nonTaxAdjustments'] || $breakdown2013['nonTaxAdjustments']) :?>
							<tr class="gross-row hidden">
								<td class="sub-item">Employer Paid Health Insurance</td>
								<td><?php echo number_format($breakdown2013['nonTaxAdjustments'], 2); ?></td>
								<td><?php echo number_format($breakdown2014['nonTaxAdjustments'], 2); ?></td>
								<td>&nbsp;</td>	
							</tr>
							<?php endif;?>
							<?php if ($breakdown2013['carBik']) :?>
							<tr class="gross-row hidden">
								<td class="sub-item">Addition due to BIK on car</td>
								<td><?php echo number_format($breakdown2013['carBik'], 2); ?></td>
								<td><?php echo number_format($breakdown2014['carBik'], 2); ?></td>
								<td>&nbsp;</td>	
							</tr>
							<?php endif;?>
							<?php if (($_GET['marital-status'] == 3) && ($breakdown2013['spouseSalary'] || $breakdown2013['spouseSalary'])) :?>
							<tr class="gross-row hidden">
								<td class="sub-item">Your Spouse's Salary</td>
								<td><?php echo number_format($breakdown2013['spouseSalary'], 2); ?></td>
								<td><?php echo number_format($breakdown2014['spouseSalary'], 2); ?></td>
								<td>&nbsp;</td>	
							</tr>
							<?php endif;?>
							<?php if (isset($breakdown2014['publicServicePension']) && ($breakdown2014['publicServicePension']['Civil Service Pension'])) :?>
                                                        <tr>
                                                                ...
                                                                <td><?php echo number_format(($breakdown2014['publicServicePension']['Civil Service Pension']), 2); ?></td>
                                                                <td>&nbsp;</td>
                                                        </tr>
                                                        <?php if (isset($breakdown2014['publicServicePension'])) :?>
                                                        <tr class="public-service-pension-row hidden">
                                                                ...
                                                                <td><?php echo number_format($breakdown2014['publicServicePension']['Contribution'], 2); ?></td>
                                                                <td>&nbsp;</td>
                                                        </tr>
							<?php if (isset($breakdown2014['publicServicePension']['Spouse & child']) && $breakdown2014['publicServicePension']['Spouse & child']) :?>
							<tr class="public-service-pension-row hidden">
                                                                ...
                                                                <td><?php echo number_format($breakdown2014['publicServicePension']['Spouse & child'], 2); ?></td>
                                                                <td>&nbsp;</td>
                                                        </tr>
							<?php endif; ?>
                                                        ...
                                                        <tr class="public-service-pension-row hidden">
                                                                ...
                                                                <td><?php echo number_format($breakdown2014['publicServicePension']['Spouse']['Contribution'], 2); ?></td>
                                                                <td>&nbsp;</td>
                                                        </tr>
                                                        <tr class="public-service-pension-row hidden">
                                                                <td class="sub-item">Spouse and child contribution (1.5%)</td>
                                                                <td><?php echo number_format($breakdown2013['publicServicePension']['Spouse']['Spouse & child'], 2); ?></td>
                                                                <td><?php echo number_format($breakdown2014['publicServicePension']['Spouse']['Spouse & child'], 2); ?></td>
                                                                <td>&nbsp;</td>
                                                        </tr>
							<?php   endif;
                                                                endif;
                                                        endif; ?>
							<?php if (isset($breakdown2013['pensionLevy']) || isset($breakdown2014['pensionLevy'])) :?>
							<tr>
							<?php if ($breakdown2014['pensionLevyBreakdown']) { ?>
							...
							<?php }?>
								...
								<td><?php echo number_format(($breakdown2014['pensionLevy']), 2); ?></td>
								<td>&nbsp;</td>
							</tr>
							<?php if (isset($breakdown2013['pensionLevyBreakdown'])) :?>
							<tr class="pension-levy-row hidden">
								...
								<td><?php echo number_format($breakdown2014['pensionLevyBreakdown']['Your Pension Levy'], 2); ?></td>
								<td>&nbsp;</td>	
							</tr>
							<?php 	if ($_GET['marital-status'] == 3) :?>
							<tr class="pension-levy-row hidden">
								...
								<td><?php echo number_format($breakdown2014['pensionLevyBreakdown']["Your Spouse's Pension Levy"], 2); ?></td>
								<td>&nbsp;</td>	
							</tr>
							<?php 	endif;
								endif;
							...
							<tr>
								...
								<td><?php echo number_format($breakdown2014['taxable'], 2); ?></td>
								<td <?php echo ($breakdown2014['taxable'] != $breakdown2013['taxable']) ? 'class="' . (($breakdown2014['taxable'] < $breakdown2013['taxable']) ? 'up' : 'down') . '"' : '';?>><?php echo number_format($breakdown2014['taxable'] - $breakdown2013['taxable'], 2); ?></td>
							</tr>
							...
							<?php if ($breakdown2014['publicServicePension']['Civil Service Pension']) :?>
							<tr class="taxable-row hidden">
							...
							<?php endif;?>
							<?php if (isset($breakdown2013['pensionRelief']) && $breakdown2013['pensionRelief']) {?>
							<tr class="taxable-row hidden">
								<td class="sub-item">Pension</td>
								<td>-<?php echo number_format($breakdown2013['pensionRelief'], 2); ?></td>
								<td>-<?php echo number_format($breakdown2014['pensionRelief'], 2); ?></td>
								<td <?php echo ($breakdown2014['pensionRelief'] != $breakdown2013['pensionRelief']) ? 'class="' . (($breakdown2014['pensionRelief'] > $breakdown2013['pensionRelief']) ? 'up' : 'down') . '"' : '';?>><?php echo number_format($breakdown2014['pensionRelief'] - $breakdown2013['pensionRelief'], 2); ?></td>
							</tr>
							<?php }?>
							<?php if (($_GET['marital-status'] == 3) && (isset($breakdown2013['taxableBreakdown']["Your Spouse's taxable"]))) {?>
							<tr class="taxable-row hidden">
								...
								<td><?php echo number_format($breakdown2014['taxableBreakdown']["Your Spouse's taxable"], 2); ?></td>
								<td <?php echo ($breakdown2014['taxableBreakdown']["Your Spouse's taxable"] != $breakdown2013['taxableBreakdown']["Your Spouse's taxable"]) ? 'class="' . (($breakdown2014['taxableBreakdown']["Your Spouse's taxable"] > $breakdown2013['taxableBreakdown']["Your Spouse's taxable"]) ? 'up' : 'down') . '"' : '';?>><?php echo number_format($breakdown2014['taxableBreakdown']["Your Spouse's taxable"] - $breakdown2013['taxableBreakdown']["Your Spouse's taxable"], 2); ?></td>
							</tr>
							<?php }?>							
							<tr>
								<?php if ($_GET['marital-status'] == 3) {?>
								...
								<td><?php echo number_format($breakdown2014['cutoff'], 2); ?></td>
								<td <?php echo ($breakdown2014['cutoff'] != $breakdown2013['cutoff']) ? 'class="' . (($breakdown2014['cutoff'] > $breakdown2013['cutoff']) ? 'up' : 'down') . '"' : '';?>><?php echo number_format($breakdown2014['cutoff'] - $breakdown2013['cutoff'], 2); ?></td>
							</tr>
							<?php if (isset($breakdown2013['cutoffBreakdown'])) :
									foreach ($breakdown2013['cutoffBreakdown'] as $name => $value) {
							?>
							<tr class='cutoff-row hidden'>
								<td class="sub-item"><?php echo $name;?></td>
								<td><?php echo (isset($breakdown2013['cutoffBreakdown'][$name])) ? number_format($breakdown2013['cutoffBreakdown'][$name], 2) : '&nbsp'?></td>
								<td><?php echo number_format($value, 2); ?></td>
								<?php if (isset($breakdown2013['cutoffBreakdown'][$name])) { ?>
								<td <?php echo ($breakdown2014['cutoffBreakdown'][$name] != $breakdown2013['cutoffBreakdown'][$name]) ? 'class="' . (($breakdown2014['cutoffBreakdown'][$name] > $breakdown2013['cutoffBreakdown'][$name]) ? 'up' : 'down') . '"' : '';?>><?php echo number_format($breakdown2014['cutoffBreakdown'][$name] - $breakdown2013['cutoffBreakdown'][$name], 2); ?></td>
								<?php } else { ?>
								<td>&nbsp;</td>
								<?php }?>
							</tr>
							...
							<tr>
								...
								<td><?php echo number_format($breakdown2014['credits'], 2); ?></td>
								<td <?php echo ($breakdown2014['credits'] != $breakdown2013['credits']) ? 'class="' . (($breakdown2014['credits'] > $breakdown2013['credits']) ? 'up' : 'down') . '"' : '';?>><?php echo number_format($breakdown2014['credits'] - $breakdown2013['credits'], 2); ?></td>
							</tr>
							<?php foreach ($breakdown2014['creditBreakdown'] as $name => $value) {?>
							<tr class='credit-row hidden'>
								<td class="sub-item"><?php echo $name;?></td>
								<td><?php echo (isset($breakdown2013['creditBreakdown'][$name])) ? number_format($breakdown2013['creditBreakdown'][$name], 2) : '&nbsp'?></td>
								<td><?php echo number_format($value, 2); ?></td>
								<?php if (isset($breakdown2013['creditBreakdown'][$name])) { ?>
								<td <?php echo ($breakdown2014['creditBreakdown'][$name] != $breakdown2013['creditBreakdown'][$name]) ? 'class="' . (($breakdown2014['creditBreakdown'][$name] > $breakdown2013['creditBreakdown'][$name]) ? 'up' : 'down') . '"' : '';?>><?php echo number_format($breakdown2014['creditBreakdown'][$name] - $breakdown2013['creditBreakdown'][$name], 2); ?></td>
								<?php } else { ?>
								<td>&nbsp;</td>
								<?php }?>
							</tr>
							<?php 
									if (isset($breakdown2013['creditBreakdown'][$name])) unset($breakdown2013['creditBreakdown'][$name]);
								}
								if (count($breakdown2013['creditBreakdown']))
								{
									foreach ($breakdown2013['creditBreakdown'] as $name => $value) {
							?>
							<tr class='credit-row hidden'>
								<td class="sub-item"><?php echo $name;?></td>
								<td><?php echo (isset($breakdown2013['creditBreakdown'][$name])) ? number_format($breakdown2013['creditBreakdown'][$name],2) : '&nbsp'?></td>
							...
							<?php 										
								...
								?>
							<?php if ($breakdown2013['extracredits'] || $breakdown2014['extracredits']) {?>	
							<tr>
								<td><?php if (count($breakdown2013['extraCreditsBreakdown']) || count($breakdown2014['extraCreditsBreakdown'])) {?>
									<div id="extra-credit" class="fake-link">Other tax relief</div>
									<?php } else {?>
										Other tax relief
									<?php }?></td>
								<td><?php echo number_format($breakdown2013['extracredits'], 2); ?></td>
								<td><?php echo number_format($breakdown2014['extracredits'], 2); ?></td>
								<td <?php echo ($breakdown2014['extracredits'] != $breakdown2013['extracredits']) ? 'class="' . (($breakdown2014['extracredits'] > $breakdown2013['extracredits']) ? 'up' : 'down') . '"' : '';?>><?php echo number_format($breakdown2014['extracredits'] - $breakdown2013['extracredits'], 2); ?></td>
							</tr>
							<?php 	foreach ($breakdown2013['extraCreditsBreakdown'] as $name => $value) {?>
							<tr class='extra-credit-row hidden'>
								<td class="sub-item"><?php echo $name;?></td>
								<td><?php echo number_format($value, 2); ?></td>
								<td><?php echo (isset($breakdown2014['extraCreditsBreakdown'][$name])) ? number_format($breakdown2014['extraCreditsBreakdown'][$name], 2) : 'N\A' ?></td>
								<td <?php echo ($breakdown2014['extraCreditsBreakdown'][$name] != $breakdown2013['extraCreditsBreakdown'][$name]) ? 'class="' . (($breakdown2014['extraCreditsBreakdown'][$name] > $breakdown2013['extraCreditsBreakdown'][$name]) ? 'up' : 'down') . '"' : '';?>><?php echo number_format($breakdown2014['extraCreditsBreakdown'][$name] - $breakdown2013['extraCreditsBreakdown'][$name], 2); ?></td>
							</tr>
							<?php 		unset($breakdown2014['extraCreditsBreakdown'][$name]);
									}
									foreach ($breakdown2014['extraCreditsBreakdown'] as $name => $value) {?>
							<tr class='extra-credit-row hidden'>
								<td><?php echo $name;?></td>
								<td>N/A</td>
								<td><?php echo number_format($breakdown2014['extraCreditsBreakdown'][$name], 2); ?></td>
								<td class='down'><?php echo '-' . number_format($breakdown2014['extraCreditsBreakdown'][$name], 2); ?></td>
							</tr>
							<?php 	}
								}?>
							<tr>
							...
							<?php if (($_GET['marital-status'] == 3) && $breakdown2014['spouseSalary']) { ?>
							...
							<?php }?>	
								...
								<td><?php echo number_format($breakdown2014['usc'], 2); ?></td>
								<td class="<?php if ($breakdown2014['usc'] > $breakdown2013['usc'] ) echo (($breakdown2014['usc'] > $breakdown2013['usc'] ) ? 'down' : 'up' );?>"><?php echo number_format(abs($breakdown2014['usc'] - $breakdown2013['usc']), 2); ?></td>
							</tr>
							<?php if (($_GET['marital-status'] == 3) && $breakdown2014['spouseSalary']) : ?>
							<tr class='usc-row hidden'>
								<td class="sub-item">Your USC</td>
								<td><?php echo number_format($breakdown2013['uscBreakdown']['Your USC'], 2); ?></td>
								<td><?php echo number_format($breakdown2014['uscBreakdown']['Your USC'], 2); ?></td>
								<td>&nbsp;</td>
							</tr>
							<tr class='usc-row hidden'>
								<td class="sub-item">Spouse's USC</td>
								<td><?php echo number_format($breakdown2013['uscBreakdown']['Spouse USC'], 2); ?></td>
								<td><?php echo number_format($breakdown2014['uscBreakdown']['Spouse USC'], 2); ?></td>
								<td>&nbsp;</td>
							</tr>
							<?php endif; ?>
							<tr>
							...
							<?php }?>
								...
								<td><?php echo number_format($breakdown2014['prsi'], 2); ?></td>
								<td<?php echo ($breakdown2014['prsi'] != $breakdown2013['prsi']) ? ' class="' . (($breakdown2014['prsi'] > $breakdown2013['prsi']) ? 'down' : 'up') . '"' : '';?>><?php echo number_format($breakdown2014['prsi'] - $breakdown2013['prsi'], 2); ?></td>
							</tr>
							<?php if (($_GET['marital-status'] == 3) && $breakdown2014['spouseSalary']) : ?>
							<tr class= "prsi-row hidden">
								...
								<td><?php echo number_format($breakdown2014['prsiBreakdown']['Your PRSI'], 2); ?></td>
								<td<?php echo ($breakdown2014['prsiBreakdown']['Your PRSI'] != $breakdown2013['prsiBreakdown']['Your PRSI']) ? ' class="' . (($breakdown2014['prsiBreakdown']['Your PRSI'] > $breakdown2013['prsiBreakdown']['Your PRSI']) ? 'up' : 'down') . '"' : '';?>><?php echo number_format($breakdown2014['prsiBreakdown']['Your PRSI'] - $breakdown2013['prsiBreakdown']['Your PRSI'], 2); ?></td>
							</tr>
							<tr class="prsi-row hidden">
								<td class="sub-item">Your spouse's PRSI</td>
								<td><?php echo number_format($breakdown2013['prsiBreakdown']['Spouse PRSI'], 2); ?></td>
								<td><?php echo number_format($breakdown2014['prsiBreakdown']['Spouse PRSI'], 2); ?></td>
								<td<?php echo ($breakdown2014['prsiBreakdown']['Spouse PRSI'] != $breakdown2013['prsiBreakdown']['Spouse PRSI']) ? ' class="' . (($breakdown2014['prsiBreakdown']['Spouse PRSI'] > $breakdown2013['prsiBreakdown']['Spouse PRSI']) ? 'up' : 'down') . '"' : '';?>><?php echo number_format($breakdown2014['prsiBreakdown']['Spouse PRSI'] - $breakdown2013['prsiBreakdown']['Spouse PRSI'], 2); ?></td>
							</tr>
							<?php endif;?>														
							<tr>
								<td><div id="tax" class="fake-link">Gross Tax</div></td>
								<td><?php echo number_format($breakdown2013['grossTax'], 2); ?></td>
								<td><?php echo number_format($breakdown2014['grossTax'], 2); ?></td>
								<td <?php echo ($breakdown2014['grossTax'] != $breakdown2013['grossTax']) ? 'class="' . (($breakdown2014['grossTax'] > $breakdown2013['grossTax']) ? 'down' : 'up') . '"' : '';?>><?php echo number_format($breakdown2014['grossTax'] - $breakdown2013['grossTax'], 2); ?></td>
							</tr>
							<?php foreach($breakdown2013['taxBreakdown'] as $taxRate => $taxItem) :?>
							<tr class="tax-row hidden">
								...
								<td><?php echo number_format($breakdown2014['taxBreakdown'][$taxRate]['amount'], 2)?></td>
								<td <?php echo ($breakdown2014['taxBreakdown'][$taxRate]['amount'] != $breakdown2013['taxBreakdown'][$taxRate]['amount']) ? 'class="' . (($breakdown2014['taxBreakdown'][$taxRate]['amount'] > $breakdown2013['taxBreakdown'][$taxRate]['amount']) ? 'down' : 'up') . '"' : '';?>><?php echo number_format(abs($breakdown2014['taxBreakdown'][$taxRate]['amount'] - $breakdown2013['taxBreakdown'][$taxRate]['amount']), 2); ?></td>
							</tr>	
							<?php 
										unset($breakdown2014['taxBreakdown'][$taxRate]);
									endforeach;
									if (count($breakdown2014['taxBreakdown'])) :
										foreach ($breakdown2014['taxBreakdown'] as $taxRate => $taxItem) :		
							?>						
							<tr class="tax-row hidden">
								<td class="sub-item"><?php echo $taxRate;?></td>
								<td>N/A</td>
								<td><?php echo $breakdown2014['taxBreakdown'][$taxRate]['amount']?></td>
								<td class="down"><?php echo number_format($breakdown2014['taxBreakdown'][$taxRate]['amount'], 2); ?></td>
							</tr>							
							<?php 
										endforeach;
									endif;
							?>
							<?php if ($breakdown2014['house']) { ?>
							<tr>
								<td>Local Property Tax</td>
								<td>N/A</td>
								<td class="down"><?php echo number_format($breakdown2014['house'], 2); ?></td>
								<td class="down"><?php echo number_format($breakdown2014['house'], 2); ?></td>
							</tr>
							<?php } ?>
							<tr>
								...
								<td><?php echo number_format($breakdown2014['tax'], 2); ?></td>
								<td <?php echo ($breakdown2014['tax'] != $breakdown2013['tax']) ? 'class="' . (($breakdown2014['tax'] > $breakdown2013['tax']) ? 'down' : 'up') . '"' : '';?>><?php echo number_format($breakdown2014['tax'] - $breakdown2013['tax'], 2); ?></td>
							</tr>
							<?php if ($breakdown2013['nonTaxAdjustments'] || $breakdown2014['nonTaxAdjustments']) :?>
							<tr>
							...
							<tr>
								...
								<td><?php echo number_format($breakdown2014['child_benefit']); ?></td>
								<td class="down"><?php echo number_format($breakdown2013['child_benefit'] - $breakdown2014['child_benefit'], 2)?></td>
							</tr>
							<?php endif; ?>
							<tr>
								...
								<td><?php echo number_format($breakdown2014['net'] - $breakdown2014['nonTaxAdjustments'] + $breakdown2014['child_benefit'], 2); ?></td>
								<td <?php echo ($breakdown2014['net'] != $breakdown2013['net']) ? 'class="' . (($breakdown2014['net'] > $breakdown2013['net']) ? 'up' : 'down') . '"' : '';?>><?php echo number_format(($breakdown2014['net'] - $breakdown2013['net']) - ($breakdown2013['child_benefit'] - $breakdown2014['child_benefit']), 2); ?></td>
							</tr>
							<tr class="net-row hidden">
								<td class="sub-item">Per month</td>
								<td><?php echo number_format(($breakdown2013['net'] - $breakdown2013['nonTaxAdjustments'] + $breakdown2013['child_benefit']) / 12, 2); ?></td>
								<td><?php echo number_format(($breakdown2014['net'] - $breakdown2014['nonTaxAdjustments'] + $breakdown2013['child_benefit']) / 12, 2); ?></td>
								<td <?php echo ($breakdown2014['net'] != $breakdown2013['net']) ? 'class="' . (($breakdown2014['net'] > $breakdown2013['net']) ? 'up' : 'down') . '"' : '';?>><?php echo number_format(($breakdown2014['net'] - $breakdown2013['net'] - ($breakdown2013['child_benefit'] - $breakdown2014['child_benefit'])) / 12, 2); ?></td>
							</tr>
							<tr class="net-row hidden">
								<td class="sub-item">Per fortnight</td>
								<td><?php echo number_format(($breakdown2013['net'] - $breakdown2013['nonTaxAdjustments'] + $breakdown2013['child_benefit']) / 26, 2); ?></td>
								<td><?php echo number_format(($breakdown2014['net'] - $breakdown2014['nonTaxAdjustments'] + $breakdown2013['child_benefit']) / 26, 2); ?></td>
								<td <?php echo ($breakdown2014['net'] != $breakdown2013['net']) ? 'class="' . (($breakdown2014['net'] > $breakdown2013['net']) ? 'up' : 'down') . '"' : '';?>><?php echo number_format(($breakdown2014['net'] - $breakdown2013['net'] - ($breakdown2013['child_benefit'] - $breakdown2014['child_benefit'])) / 26, 2); ?></td>
							</tr>
							<tr class="net-row hidden">
								<td class="sub-item">Per week</td>
								<td><?php echo number_format(($breakdown2013['net'] - $breakdown2013['nonTaxAdjustments'] + $breakdown2013['child_benefit']) / 52, 2); ?></td>
								<td><?php echo number_format(($breakdown2014['net'] - $breakdown2014['nonTaxAdjustments'] + $breakdown2013['child_benefit']) / 52, 2); ?></td>
								<td <?php echo ($breakdown2014['net'] != $breakdown2013['net']) ? 'class="' . (($breakdown2014['net'] > $breakdown2013['net']) ? 'up' : 'down') . '"' : '';?>><?php echo number_format(($breakdown2014['net'] - $breakdown2013['net'] - ($breakdown2013['child_benefit'] - $breakdown2014['child_benefit'])) / 52, 2); ?></td>
							</tr>
						</table>
						<?php endif;?>
							...
							<div class="clear">
								...
								<div class="basic-calc-row">
									...
									<div class="row<?php echo ($errors['children']) ? ' error-row' : ''?>">
										...
										<div class="input"> 
											<select id="children" name="children" onchange="javascript:hasChildren();">
...
<option value="8" <?php echo (isset($_GET['children']) && $_GET['children'] == 8) ? 'selected="selected"' : '';?>>8</option>
									...
									<div id="primary-carer-row" class="<?php echo (isset($_GET['primary_carer']) && $_GET['primary_carer']) ? '' : 'hidden'?> row">
										<div class="label">Are you the primary carer?</div>
										<div class="input"> 
												<select id="primary_carer" name="primary_carer">
									    ...
									    <div class="row<?php echo ($errors['widow-parent-bereaved']) ? ' error-row' : ''?>">
									    	...
									    	<div class="input">
											    <select name="widow-parent-bereaved">
											      ...
											      <option value="2006" <?php echo (isset($_GET['widow-parent-bereaved']) && $_GET['widow-parent-bereaved'] == 2006) ? 'selected="selected"' : '';?>>2005</option>
											      <option value="2007" <?php echo (isset($_GET['widow-parent-bereaved']) && $_GET['widow-parent-bereaved'] == 2007) ? 'selected="selected"' : '';?>>2006</option>
											      <option value="2008" <?php echo (isset($_GET['widow-parent-bereaved']) && $_GET['widow-parent-bereaved'] == 2008) ? 'selected="selected"' : '';?>>2007</option>
											      <option value="2009" <?php echo (isset($_GET['widow-parent-bereaved']) && $_GET['widow-parent-bereaved'] == 2009) ? 'selected="selected"' : '';?>>2008</option>
											      <option value="2010" <?php echo (isset($_GET['widow-parent-bereaved']) && $_GET['widow-parent-bereaved'] == 2010) ? 'selected="selected"' : '';?>>2009</option>
											      <option value="2011" <?php echo (isset($_GET['widow-parent-bereaved']) && $_GET['widow-parent-bereaved'] == 2011) ? 'selected="selected"' : '';?>>2010</option>
<option value="2012" <?php echo (isset($_GET['widow-parent-bereaved']) && $_GET['widow-parent-bereaved'] == 2012) ? 'selected="selected"' : '';?>>2011</option>
<option value="2013" <?php echo (isset($_GET['widow-parent-bereaved']) && $_GET['widow-parent-bereaved'] == 2013) ? 'selected="selected"' : '';?>>2013</option>
											    </select>
											 </div>
									    </div>
									</div>
	...
	<ul>
		<li>
			<a href="http://twitter.com/share" class="twitter-share-button" data-url="http://taxcalc.ie/budget-2014/" data-text="TaxCalc Budget calculator 2014" data-count="none" data-via="taxcalc_ie">Tweet</a>
		</li>
		<li>
...
{
        if (($("#children").val() > 0) 
        	&& ($("#marital-status").val() == 1) || ($("#marital-status").val() == 4))
        {
                $("#primary-carer-row").show();
        }
        else
        {
                $("#primary-carer-row").hide();
        }
}
</script>
